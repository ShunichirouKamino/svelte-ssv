...
<h1>Register Form</h1>
<p class="description">
	<code>createEnhanceForm</code> — unified form state + SvelteKit <code>use:enhance</code>
	in a single call. Includes touched/dirty tracking and cross-field validation.
</p>
...
<section class="code-note">
	...
	<ul>
		<li>
			<code>createEnhanceForm(schema, options)</code> — single call sets up
			form state, validation, touched/dirty tracking, and <code>use:enhance</code> handler
		</li>
		<li>
